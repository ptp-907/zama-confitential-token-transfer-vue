...
// Confidential Wrapped USDT Contract ABI
export const CWUSDT_CONTRACT_ABI = [
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "decryptedBalance", type: "uint256" },
    ],
    name: "_userDecryptCallback",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
